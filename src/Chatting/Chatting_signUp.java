...
public class Chatting_signUp implements ActionListener{
    ...
    public Chatting_signUp() {
        frame = new JFrame();
        frame.setTitle("InsideOut");
        frame.setIconImage(Toolkit.getDefaultToolkit().getImage("C:\\Mtest\\Chatting Project\\RainBow.jpg"));
        ...
        Label_SignUp.setBounds(40, 25, 200, 50);
        Label_SignUp.setFont(new Font("Arial Black", Font.PLAIN, 40));
    ...
    public void selChar() {
      ...
      ImageIcon[] images = {new ImageIcon("C:/Mtest/Chatting Project/Joy.jpg"), 
        ...
        ComChar.setBackground(new Color(255, 255, 255));
